...
const handleSubmit = async(e) => {
  ...
  const URL = `${process.env.REACT_APP_BACKDEND_UR}/api/register`
        ...
        <form className='grid gap-4 mt-5' onSubmit={handleSubmit}>
          ...
          <div className='flex flex-col gap-1'>
            <label htmlFor='profile_pic'>Photo : 
              <div className='h-14 bg-slate-200 flex items-center justify-center rounded hover:border-primary cursor-pointer'>
                <p className='text-sm max-w-sm w-[300px] text-ellipsis line-clamp-1'>
                  {
